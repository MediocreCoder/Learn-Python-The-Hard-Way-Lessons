# REVIEW ANY COMPLEX PYTHON CODE FOR EXERCISE 23
# Source: www.Github.com, https://github.com/sbp/phenny/blob/master/modules/translate.py
# Author: Phenny
# Code Purpose: Get English translation (Using Google Translate)
